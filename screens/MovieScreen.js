...
export default function MovieScreen() {
  ...
  return (
    <ScrollView 
      ...
      <StyledView style={{marginTop: -(height*0.09)}} className="space-y-3">
        {/* title */}
        <StyledText className="text-white text-center text-3xl font-bold tracking-widest">
            {
                movie?.title
            }
        </StyledText>
        ...
        {
            movie?.id? (
                <StyledText className="text-neutral-400 font-semibold text-base text-center">
        ...
        <StyledView className="flex-row justify-center mx-4 space-x-2">
            {
                movie?.genres?.map((genre,index)=>{
                    ...
                    return (
                        <StyledText key={index} className="text-neutral-400 font-semibold text-base text-center">
